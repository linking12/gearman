...
public class PostgresExceptionStorageEngine implements ExceptionStorageEngine {
    ...
    public PostgresExceptionStorageEngine(final String hostname, final int port, final String database,
        ...
        this.createTableQuery = String.format("CREATE TABLE %s(id bigserial, job_handle text, unique_id text, job_data bytea, exception_data bytea, exception_time bigint)",
                                              tableName);
