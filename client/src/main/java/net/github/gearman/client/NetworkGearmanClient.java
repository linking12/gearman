...
import net.github.gearman.common.client.AbstractGearmanClient;
...
public class NetworkGearmanClient extends AbstractGearmanClient {
    ...
    public byte[] submitJob(String callback, byte[] data, JobPriority priority) throws NoServersAvailableException,
                                                                                WorkException {
        Packet result = null;
    ...
    public String submitJobInBackground(String callback, byte[] data,
