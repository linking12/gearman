...
import net.github.gearman.server.util.SystemSnapshot;
...
public class StatusView {
    ...
    public String getUptime() {
        ...
        if (timeMap.DAYS == 0) {
            if (timeMap.HOURS == 0) res = String.format("%dmin.", timeMap.MINUTES);
            else res = String.format("%dhrs.", timeMap.HOURS);
