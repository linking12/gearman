...
public class HazelcastConfiguration {
    ...
    public HazelcastInstance getHazelcastInstance() {
        ...
        if (hazelcast == null) {
            ...
            /*
             * MapConfig mapCfg = new MapConfig(); mapCfg.setName("testMap"); mapCfg.setBackupCount(2);
             * mapCfg.getMaxSizeConfig().setSize(10000); mapCfg.setTimeToLiveSeconds(300); MapStoreConfig mapStoreCfg =
             * new MapStoreConfig(); mapStoreCfg.setClassName("com.hazelcast.examples.DummyStore").setEnabled(true);
             * mapCfg.setMapStoreConfig(mapStoreCfg); NearCacheConfig nearCacheConfig = new NearCacheConfig();
             * nearCacheConfig.setMaxSize(1000).setMaxIdleSeconds(120).setTimeToLiveSeconds(300);
             * mapCfg.setNearCacheConfig(nearCacheConfig); cfg.addMapConfig(mapCfg);
             */
