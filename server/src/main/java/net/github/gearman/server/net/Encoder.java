...
public class Encoder extends MessageToByteEncoder<Object> {
    ...
    public static byte[] encodePacket(Packet packet) throws IllegalArgumentException {

        LOG.debug("<--- " + packet.getType());
        return packet.toByteArray();
    }

    public static byte[] encodeString(String message) throws IllegalArgumentException {
        LOG.debug("<--- " + message);
