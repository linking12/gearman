...
import net.github.gearman.common.packets.PacketFactory;
import net.github.gearman.util.ByteArray;
...
public class Decoder extends ReplayingDecoder<Decoder.DecodingState> {
    ...
    @Override
    protected void decode(ChannelHandlerContext ctx, ByteBuf buffer, List<Object> decoded) throws Exception {
    ...
    public enum DecodingState {
                               HEADER, PAYLOAD, TEXT // Text command
    }
}
