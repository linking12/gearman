...
/**
 * Created with IntelliJ IDEA. User: jewart Date: 11/30/12 Time: 8:01 AM To change this template use File | Settings |
 * File Templates.
 */
public enum PacketType {
    ...
    public static PacketType fromPacketMagicNumber(int x) {
        switch (x) {
            ...
            case 38:
                return SUBMIT_REDUCE_JOB_BACKGROUND;
            case 39:
                return GRAB_JOB_ALL;
            case 40:
                return JOB_ASSIGN_ALL;
            case 41:
                return GET_STATUS_UNIQUE;
            case 42:
                return STATUS_RES_UNIQUE;
        }
        return null;
    }
}
